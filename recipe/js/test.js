...
// }
        $("button").click(function(){
          ...
          $.ajax({
            url:"https://api.spoonacular.com/recipes/findByIngredients?ingredients="+newVariable+"&apiKey=107bac205003452fa30477e74b30fa68",
            type: "GET" ,
              ...
              for(var p=0;p<result.length;p++)
                {
                  ...
                  $.ajax({
                  async: false,
                  url:"https://api.spoonacular.com/recipes/"+ID+"/information?includeNutrition=true&apiKey=107bac205003452fa30477e74b30fa68",
                  type: "GET" ,
                  success: function(result)
                  {
                    //alert(ID);
                  ...
                  $.ajax({
                  async: false,
                  url:"https://api.spoonacular.com/recipes/"+ID+"/nutritionWidget.json?apiKey=107bac205003452fa30477e74b30fa68",
                  type: "GET" ,
                  success: function(result)
                  {
                    console.log();
